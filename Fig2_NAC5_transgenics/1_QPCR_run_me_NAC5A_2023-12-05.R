...
primer_efficiencies <- read_csv("Primer_efficiencies_NAC5_2021-07-27.csv", col_names = FALSE)
...
#ONLY LINES PHENOTYPED, for paper
#i.e. remove 8.26
qPCR_v3 <-qPCR_v3 %>%
  filter(Line_name != "8.26")
...
write.csv(analysis, file = paste("qPCR_", experiment_title, "wo8.26_", "analysis_pfaffl_",today_date, ".csv", sep=""))
